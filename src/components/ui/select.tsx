...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('py-1.5 pr-8 pl-2 text-sm font-semibold text-gray-600', className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-md py-2 pr-8 pl-2 text-sm outline-none',
      'focus:bg-[#2D6A4F]/10 focus:text-[#2D6A4F]',
