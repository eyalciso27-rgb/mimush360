  ...
  return (
    <a
      ...
      className={cn(
        ...
        'hover:bg-[#20B857] hover:shadow-xl',
        'focus:outline-none focus:ring-4 focus:ring-[#25D366]/30',
        'group animate-pulse-slow',
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      )}
      aria-label="פתח שיחת וואטסאפ - שלח הודעה"
      role="link"
    >
      {/* Ping effect */}
      <span className="absolute -inset-1 rounded-full bg-[#25D366]/30 animate-ping" aria-hidden="true" />
